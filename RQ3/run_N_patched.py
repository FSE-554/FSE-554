...
def run_with_vllm_direct(data: List[Dict], model_source: str) -> List[Dict]:
    ...
    for out in outputs:
        ...
        final_text = trimmed if trimmed else text
        results_list.append({"answer": final_text})
...
def main():
    ...
    parser.add_argument("--base_results_dir", type=str, required=True, help="Base results directory")
    parser.add_argument("--input_basename", type=str, required=True, help="Input file base name")
    parser.add_argument("--output_basename", type=str, required=True, help="Output file base name")
